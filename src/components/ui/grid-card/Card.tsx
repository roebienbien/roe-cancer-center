...
const Card = ({ title, img }: CardProps) => {
  return (
    <div className='relative overflow-hidden rounded-xl shadow-xl group-hover:scale-105'>
      {/* Background Image */}
      <UnsplashImage
        photoId={img}
        alt='location-image'
      ...
      {/* Text Content */}
      <div className='absolute bottom-4 left-4 flex flex-col text-2xl font-bold text-white'>
